...
class _ApiService implements ApiService {
  ...
  @override
  Future<ActorResponseModel> getActors(int page) async {
  ...
  Future<ActorModel> getActorDetails(int personId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ActorModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'person/${personId}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ActorModel _value;
    try {
      _value = ActorModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
